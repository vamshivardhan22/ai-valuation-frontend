  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL ?? "https://ai-valuation-backend-1.onrender.com"}/predict/house-rent`,
        {
          method: "POST",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div className="bg-white/5 p-6 rounded-2xl shadow-lg min-h-[220px]">
            ...
            {!result && !loading && (
              <p className="text-gray-400">Fill form and click Predict to see rent estimate.</p>
            )}
          ...
          <div className="bg-white/10 p-4 rounded-xl text-sm text-gray-300">
            ...
            <p>
              Our AI model evaluates local market conditions, amenities, building type, furnishing,
              and geographic factors to estimate monthly rental value.
            </p>
          </div>
        </div>
      </div>
