  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL ?? "https://ai-valuation-backend-1.onrender.com"}/predict/land-price`,
        {
          method: "POST",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div className="bg-white/5 p-6 rounded-2xl shadow-lg min-h-[220px]">
            ...
            {!result && !loading && (
              <p className="text-gray-400">Fill the form and click Predict.</p>
            )}
          ...
          <div className="bg-white/10 p-4 rounded-xl text-sm text-gray-300">
            ...
            <p>
              Our AI analyzes local market trends, zoning rules, road access, plot shape and geospatial patterns to predict
